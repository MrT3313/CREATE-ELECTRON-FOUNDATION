...
# create-electron-foundation tanstack-router-sqlite-drizzle --router=tanstack-router --styles=none --database=sqlite --orm=drizzle --install_packages=false --git=true --ide=cursor
# create-electron-foundation react-router-sqlite-drizzle --router=react-router --styles=none --database=sqlite --orm=drizzle --install_packages=false --git=true --ide=cursor
